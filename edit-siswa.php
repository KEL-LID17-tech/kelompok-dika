          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="id_siswa" value="<?php echo $row['id_siswa'] ?>" placeholder="Masukkan id Siswa" class="form-control">
                </div>

                <div class="form-group">
                  <label>NISN</label>
                  <input type="text" name="nisn" value="<?php echo $row['nisn'] ?>" placeholder="Masukkan NISN Siswa" class="form-control”>
                  <input type=" name="id_siswa" value="<?php echo $row['id_siswa'] ?>">
                </div>
